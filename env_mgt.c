...
/**
 * get_env_value - Gets the val corresponding to an environmental variable.
 * @beginning: The environmental variable to search for.
 * @len: The length of the environmental variable to search for.
 * Return: If the variable is not found - an empty string.
 *         Otherwise - the val of the environmental variable.
 * Description: Variables are stored in the form VARIABLE=VALUE.
 */
...
/**
 * sh_env - Prints the current environ.
